...
serve(async (req) => {
  ...
  try {
    ...
    Always provide practical, actionable advice. Use Indian Rupees (₹) for all cost estimates. Consider Indian holidays and long weekends in your recommendations. Be enthusiastic but informative. Keep responses concise but helpful.`
